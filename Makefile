...
qa:
	isort src/plasmid_verification tests/ setup.py
	black src/plasmid_verification tests/ setup.py

.PHONY: release
## Prepare a release by generating the automatic code documentation.
release:
	sphinx-apidoc -f -o docs/source/autogen src/plasmid_verification
